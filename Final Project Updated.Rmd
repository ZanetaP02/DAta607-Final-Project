...
fd_pop <- Reduce(merge,list(df22,df20,df18))
head(df_pop)
...
The bar graph "Drivers Population for the Years 2018, 2020, & 2022" shows driver population across different U.S. states and the tables of the hist and lows State Driver Population. Here are the key observations:
...
## Conclusion 
Data collected indicates that states with high driver populations tend to have high fatal accident rates, and this trend is similar for states with the lowest driver populations.

We can also examine the relationship between the number of drivers and the incidence of fatal accidents in the USA, we can set up the null and alternative hypotheses: 
